# Contributing to MedrixFlow

Thank you for your interest in contributing to MedrixFlow! This guide will help you set up your development environment and understand our development workflow.
...
Host Machine
  ↓
Docker Compose (medrix-flow-dev)
...
- Check existing [Issues](https://github.com/bytedance/medrix-flow/issues)
- Read the [Documentation](backend/docs/)
- Ask questions in [Discussions](https://github.com/bytedance/medrix-flow/discussions)

## License

By contributing to MedrixFlow, you agree that your contributions will be licensed under the [MIT License](./LICENSE).
