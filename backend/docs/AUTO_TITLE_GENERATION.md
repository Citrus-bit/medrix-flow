...
{
  "graphs": {
    "lead_agent": "medrix_flow.agents:lead_agent"
  },
...
```python
from medrix_flow.config.title_config import TitleConfig, set_title_config
...
# 测试 title 生成
import pytest
from medrix_flow.agents.title_middleware import TitleMiddleware
...
- [`packages/harness/medrix_flow/agents/thread_state.py`](../packages/harness/medrix_flow/agents/thread_state.py) - ThreadState 定义
- [`packages/harness/medrix_flow/agents/title_middleware.py`](../packages/harness/medrix_flow/agents/title_middleware.py) - TitleMiddleware 实现
- [`packages/harness/medrix_flow/config/title_config.py`](../packages/harness/medrix_flow/config/title_config.py) - 配置管理
- [`config.yaml`](../config.yaml) - 配置文件
- [`packages/harness/medrix_flow/agents/lead_agent/agent.py`](../packages/harness/medrix_flow/agents/lead_agent/agent.py) - Middleware 注册
