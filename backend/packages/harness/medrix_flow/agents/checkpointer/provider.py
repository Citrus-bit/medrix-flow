...
Usage::
    ...
    from medrix_flow.agents.checkpointer.provider import get_checkpointer, checkpointer_context
...
from medrix_flow.config.checkpointer_config import CheckpointerConfig
from medrix_flow.config.paths import resolve_path
...
def get_checkpointer() -> Checkpointer:
    ...
    from medrix_flow.config.app_config import _app_config
    from medrix_flow.config.checkpointer_config import get_checkpointer_config
