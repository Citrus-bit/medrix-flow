...
from medrix_flow.config.paths import VIRTUAL_PATH_PREFIX, Paths, get_paths
from medrix_flow.sandbox.sandbox import Sandbox
from medrix_flow.sandbox.sandbox_provider import SandboxProvider
...
class AioSandboxProvider(SandboxProvider):
    ...
    def _get_thread_mounts(thread_id: str) -> list[tuple[str, str, bool]]:
        ...
        # host_paths resolves to the host-side base dir when MEDRIX_FLOW_HOST_BASE_DIR
    ...
    def _get_skills_mount() -> tuple[str, str, bool] | None:
        ...
        Mount source uses MEDRIX_FLOW_HOST_SKILLS_PATH when running inside Docker (DooD)
        ...
        try:
            ...
            if skills_path.exists():
                ...
                host_skills = os.environ.get("MEDRIX_FLOW_HOST_SKILLS_PATH") or str(skills_path)
