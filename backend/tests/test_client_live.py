"""Live integration tests for MedrixFlowClient with real API.
...
from medrix_flow.client import MedrixFlowClient, StreamEvent
...
def client():
    """Create a real MedrixFlowClient (no mocks)."""
    return MedrixFlowClient(thinking_enabled=False)
