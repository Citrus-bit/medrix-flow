...
from medrix_flow.community.infoquest import tools
from medrix_flow.community.infoquest.infoquest_client import InfoQuestClient
...
class TestInfoQuestClient:
    ...
    @patch("medrix_flow.community.infoquest.infoquest_client.requests.post")
    ...
    @patch("medrix_flow.community.infoquest.tools.get_app_config")
