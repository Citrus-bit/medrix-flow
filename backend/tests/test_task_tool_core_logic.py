...
def test_task_tool_emits_running_and_completed_events(monkeypatch):
    ...
    # task_tool lazily imports from medrix_flow.tools at call time, so patch that module-level function.
    monkeypatch.setattr("medrix_flow.tools.get_available_tools", get_available_tools)
