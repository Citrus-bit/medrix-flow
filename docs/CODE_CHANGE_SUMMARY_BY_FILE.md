...
### 2. `backend/packages/harness/medrix_flow/agents/lead_agent/prompt.py`
...
### 4. `backend/packages/harness/medrix_flow/subagents/builtins/general_purpose.py`
...
### 25. `frontend/public/demo/threads/.../user-data/outputs/research_medrix_flow_20260201.md`

```diff
@@ -1,12 +1,3 @@
-<citations>
-{"id": "cite-1", "title": "MedrixFlow GitHub Repository", "url": "https://github.com/bytedance/medrix-flow", "snippet": "..."}
-...（共 7 条 JSONL）
-</citations>
